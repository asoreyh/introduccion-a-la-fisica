...
Lee los datos del archivo exoplanetas.csv, los procesa, elige uno y calcula 
su órbita en dos partes: 
1) Lectura y selección de exoplanetas del catálogo
2) Cálculo de la órbita del exoplaneta elegido
"""
...
exoplanetas = []
for linea in open("exoplanetas.csv"):  # itero sobre todo el archivo problema.dat
